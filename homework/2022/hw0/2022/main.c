...
int main() 
{
    ...
    /*
     Below I have written code to read two fractional numbers and 
     printing the results of addition, subtraction, multiplication and division
    */
    printf("num1:\n");
    scanf("%d",&num1);
    printf("den1:\n");
    ...
    fraction_simplify(&num1,&den1);
    fraction_simplify(&num2,&den2);
